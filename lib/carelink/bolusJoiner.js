...
/*
 * asserts the expected sort order on the observable: uploadId -> seqNum
 */
function assertExpectedSortOrder(obs) {
  var maxUploadId = '';
  var maxSeqNum = -1;

  return obs.map(function (e) {
    if (e.uploadId == null || e.uploadSeqNum == null) {
      if (e.type === 'bolus' || e.type === 'wizard') {
        throw except.ISE(
